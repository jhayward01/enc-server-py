...
class BEServerTestSuite(unittest.TestCase):
    ...
    def test_bad_store(self):
        ...
        store_message = f"STORE {BEServerTestSuite.id_hex_enc} {BEServerTestSuite.record_hex_enc}\n".encode('utf-8')
    ...
    def test_bad_retrieve(self):
        ...
        retrieve_message = f"RETRIEVE {BEServerTestSuite.id_hex_enc}\n".encode('utf-8')
    ...
    def test_bad_delete(self):
        ...
        delete_message = f"DELETE {BEServerTestSuite.id_hex_enc}\n".encode('utf-8')
    ...
    def test_db(self):
        ...
        retrieve_message = f"RETRIEVE {BEServerTestSuite.id_hex_enc}\n".encode('utf-8')
        retrieve_response = server.respond(retrieve_message)
        self.assertEqual(BEServerTestSuite.record_hex_enc, retrieve_response.decode('utf-8').strip())
