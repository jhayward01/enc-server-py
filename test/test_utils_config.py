...
class ConfigTestSuite(unittest.TestCase):
    ...
    config_map = {
        ...
        'feServerConfigs': {'keySize': '32', 'idKeyStr': 'vkAZAarLbZ6w0kmL2HJP3eU1ODCgVj4k',
                            'idNonceStr': '9bc423909ac5', 'port': '7777', 'useExtIP': 'True'},
        'beServerConfigs': {'port': '8888', "useExtIP": 'True', 'mongoURI': 'mongodb://user:pass@mongodb'},
    ...
    def test_load_configs(self):
        loaded_map = enc_server.utils.ConfigFile.load_configs(ConfigTestSuite.config_path)
        self.assertEqual(loaded_map, ConfigTestSuite.config_map)

    def test_load_configs_err(self):
        self.assertRaises(FileNotFoundError, enc_server.utils.ConfigFile.load_configs,
                          ConfigTestSuite.bad_config_path)

    def test_verify_configs(self):
        result, missing = enc_server.utils.ConfigFile.verify_configs(ConfigTestSuite.config_map,
